...
public class WaitHandler extends AProcessor<IA2aCCDelegates, A2aCommandCenterModel, ActionParameter, ActionResult> {

    public WaitHandler(A2aCommandCenterModel model) {
        super(model);
