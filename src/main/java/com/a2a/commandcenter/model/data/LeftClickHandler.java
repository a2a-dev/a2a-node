...
public class LeftClickHandler extends Processor<IA2aCCDelegates, A2aCommandCenterModel, ActionParameter, ActionResult> {

    public LeftClickHandler(A2aCommandCenterModel model) {
        super(model);
